...
/**
 * This file handles the filling calendar Database Operations for modified table of filling calendar .
 * 
 * @author Amruta Kadam
 * @since 24-05-2018
 * @version 1.0
	...
	public Map<Long, Map<Long, FillingEndDatesBean>> fetchFormFillingEndDatesDates(Return returnObj, EntityBean entityObj, String reportingDate, Integer returnPropertyValId) throws ServiceException, ParseException {
		...
		if (fillingCalendarObj != null) {
			if (fillingCalendarObj.getIsApplicable() != null && fillingCalendarObj.getIsApplicable().equals(Boolean.TRUE)) {
				...
				if (formFreqId.equals(RevisionRequestConstants.FREQ_ID_FIRST_HALF_MONTHLY_EXCLUDE_HOLIDAY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_FORTNIGHTLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_WEEKLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_DAILY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_FORTNIGHTLY_15_DAYS.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_QUARTERLY_WITH_LAST_FORTNIGHT_OF_QUARTER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_MONTHLY_WITH_LAST_FORTNIGHT_OF_QUARTER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_MONTHLY_WITH_LAST_FORTNIGHT_OF_QUARTER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_QUARTERLY_WITH_LAST_FORTNIGHT_OF_QUARTER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_MONTHLY_WITH_LAST_FRIDAY_OF_QUARTER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_HALF_MONTHLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_ANNUALLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_HALF_YEARLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_QUARTERLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_ANNUAL_QUATER.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_ANNUALLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_MONTHLY.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_ANNUALY_WITH_LAST_FRIDAY_OF_FINYEAR.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.CUSTOMIZED_ANNUALY_WITH_LAST_FRIDAY_OF_JUNE.getConstantLongVal()) || formFreqId.equals(RevisionRequestConstants.FREQ_ID_CUSTOMIZED_HALF_YEARLY.getConstantLongVal())) {
				...
				if (dateValidationsControlObj.getDayDiff(todaysDate, reportingDate, DateConstants.DD_MM_YYYY.getDateConstants()) >= 0) { // If reporting date is greater than or equal to todays date
