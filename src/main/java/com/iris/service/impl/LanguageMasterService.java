...
public class LanguageMasterService implements GenericService<LanguageMaster, Long> {
	...
	@Override
	public List<LanguageMaster> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<LanguageMaster> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<LanguageMaster> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public LanguageMaster getAllActiveLanguageWrapper(String languageCode) {
		return repo.findByLanguageCodeAndIsActiveTrue(languageCode);
	}
