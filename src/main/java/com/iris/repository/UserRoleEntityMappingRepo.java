...
public interface UserRoleEntityMappingRepo extends JpaRepository<UserRoleEntityMapping, Long> {
	...
	@Query(value = "select new com.iris.model.UserRoleEntityMapping(userRoleEntityMapping.userRole.userRoleId, " + " userRoleEntityMapping.entity.entityId, userRoleEntityMapping.entity.entityCode,userRoleEntityMapping.isActive) " + " FROM UserRoleEntityMapping userRoleEntityMapping where userRoleEntityMapping.userRole.userRoleId IN :roleIds order by lastmMdifiedOn asc")
