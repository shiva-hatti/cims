...
public class FileDetailsBean implements Serializable {
	...
	private String uploadChannelStr;

	private String failedJsonStr;
	...
	/**
	 * @param nillabelComments the nillabelComments to set
	 */
	...
	/**
	 * @param workflowStepNo the workflowStepNo to set
	 */
	...
	/**
	 * @return the uploadChannelStr
	 */
	public String getUploadChannelStr() {
		return uploadChannelStr;
	}

	/**
	 * @param uploadChannelStr the uploadChannelStr to set
	 */
	public void setUploadChannelStr(String uploadChannelStr) {
		this.uploadChannelStr = uploadChannelStr;
	}

	/**
	 * @return the failedJsonStr
	 */
	public String getFailedJsonStr() {
		return failedJsonStr;
	}

	/**
	 * @param failedJsonStr the failedJsonStr to set
	 */
	public void setFailedJsonStr(String failedJsonStr) {
		this.failedJsonStr = failedJsonStr;
	}

	/**
	 * @return the folderDate
	 */
	...
	/**
	 * @param folderDate the folderDate to set
	 */
