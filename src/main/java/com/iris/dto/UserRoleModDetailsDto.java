 ...
 * @author sanjayv
 */
public class UserRoleModDetailsDto implements Serializable {

	private static final long serialVersionUID = 8813042586892944078L;

	private Long userRoleModDetailsId;
	...
	//private List<RoleNameDto> roleNameDto = new ArrayList<RoleNameDto>();
	...
	private String selectedReturnText;
	...
	/*
	 * public List<RoleNameDto> getRoleNameDto() { return roleNameDto; }
	 * 
	 * public void setRoleNameDto(List<RoleNameDto> roleNameDto) { this.roleNameDto
	 * = roleNameDto; }
	 */
	...
	public Long getUserRoleModDetailsId() {
		return userRoleModDetailsId;
	}

	public void setUserRoleModDetailsId(Long userRoleModDetailsId) {
		this.userRoleModDetailsId = userRoleModDetailsId;
	}
	...
	public String getSelectedReturnText() {
		return selectedReturnText;
	}

	public void setSelectedReturnText(String selectedReturnText) {
		this.selectedReturnText = selectedReturnText;
	}
	...
	public void setSelectedMenuText(String selectedMenuText) {
		this.selectedMenuText = selectedMenuText;
	}

	public String getSelectedEntityText() {
		return selectedEntityText;
	}

	public void setSelectedEntityText(String selectedEntityText) {
		this.selectedEntityText = selectedEntityText;
	}

	public String getSelectedActivityText() {
		return selectedActivityText;
	}

	public void setSelectedActivityText(String selectedActivityText) {
		this.selectedActivityText = selectedActivityText;
	}
