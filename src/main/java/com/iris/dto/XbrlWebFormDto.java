...
public class XbrlWebFormDto {
	...
	public String getTaxonomyXsd() {
		return taxonomyXsd;
	}

	public void setTaxonomyXsd(String taxonomyXsd) {
		this.taxonomyXsd = taxonomyXsd;
	}
	...
	public void setXbrl(boolean isXbrl) {
		this.isXbrl = isXbrl;
	}
