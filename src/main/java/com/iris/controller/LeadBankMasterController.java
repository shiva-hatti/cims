...
public class LeadBankMasterController {
	...
	@PostMapping("/getLeadBankDetails")
	public ServiceResponse getLeadBankDetails() {
...
//			}
			leadBankMasterList = leadBankMasterService.findLeadBankDetailsByReturnCode();
			...
			for (LeadBankMaster leadBankMaster : leadBankMasterList) {
				option = new Option();
				option.setKey(leadBankMaster.getLeadBankName());
				option.setValue(leadBankMaster.getLeadBankName());
