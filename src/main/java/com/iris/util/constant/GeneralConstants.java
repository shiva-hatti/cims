...
/**
 * This class would store all the generic constants to be used in the application
 * 
 * @author sajadhav
 * @version 1.1
 */
public enum GeneralConstants {
	...
	AUDITOR_ROLE_TYPE_ID(3L),
	NBFC_ROLE_TYPE_ID(4L),
	APPID_SEPERATOR("~"),
	JWT_TOKEN("jwtToken"),
	EMAIL_TO(1),
	EMAIL_CC(2),
	...
	FILING_HISTORY_CHART_SETTING("filingHistory"),
	REVISION_REQUEST_CHART_SETTING("revisionRequest"),
	RETURN_CODE("ReturnCode"),
	ENTITY_CODE("EntityCode"),
	START_DATE("StartDate"),
	FREQUENCY("Frequency"),
	SP_PARENT_DROPDOWN_TYPE("CALL SP_DROP_DOWN_TYPE(?,?)"),
	SP_CHILD_DROPDOWN_VAL("CALL SP_INSERT_DROP_DOWN_TYPE_VALUES(?,?,?)"),
	ENTITY_COD("entityCode"),
	ENTITY_NAME("entityName"),
	ENTITY_COD_ENTITY_NAME("entityCodeEntityName"),
	SDMX("SDMX"),
	XBRL("XBRL"),
	ADD_USER_AUDITOR_ROLE("ADD_USER_AUDITOR_ROLE"),
	GET_USER_AUD_ROLE_BY_AUD_ID_FIRM_ID("GET_USER_AUD_ROLE_BY_AUD_ID_FIRM_ID"),
	NOT_DEPT_ADMIN("0"),
	EMPTY_DATA("-"),
	ENTITY_LABEL_PROCEDURE("CALL SP_INSERT_ENTITY_LBL(?,?)"),
	DEPT_USER_ID(3L),
	CUR_FY_END_DATE("currentFinYrEndDate"),
	PRV_FY_END_DATE("prvFinYrEndDate"),
	SECOND_PRV_FY_END_DATE("secondPrvFinYrEndDate"),
	FILE_UPLOAD("File Upload"),
	DROPDOWN_TYPE_LIST("dropDownTypeList"),
	ELR_TAG_LIST("elrTagList"),
	FOREIGN_SUB_CATEGORY_ID(6L),
	FIRST_ALTERNATIVE_FRIDAY("firstAlternativeFriday"),
	SECOND_ALTERNATIVE_FRIDAY("secondAlternativeFriday"),
	THIRD_ALTERNATIVE_FRIDAY("thirdAlternativeFriday"),
	RBI_SUPER_USER(1L),
	R251("R251"),
	FIRST_ALTERNATIVE_FRIDAY_START_DATE("firstAlternativeFridayStartDate"),
	SECOND_ALTERNATIVE_FRIDAY_FRIDAY_START_DATE("secondAlternativeFridayStartDate"),
	THIRD_ALTERNATIVE_FRIDAY_FRIDAY_START_DATE("thirdAlternativeFridayStartDate"),
	SADP_IDENTIFIER("SADP"),
	TEMPLATE_VIEW_TYPE_OF_REQUEST(1),
	ELEMENT_VIEW_TYPE_OF_REQUEST(0),
	R146("R146"),
	R327("R327"),
	R328("R328"),
	AUDITED_PROPERTY_VAL(1),
	UN_AUDITED_PROPERTY_VAL(2),
	PROVISIONAL_PROPERTY_VAL(3),
	FINAL_PROPERTY_VAL(4),
	R105("R105"),
	ENT_LEVEL_SEPERATOR("%7C"),
	CUSTOM_SUCCESS_ID(15),
	ELEMENT_DETAILS("elementDetails"),
	ERROR_CODE_AND_MSG_DETAILS("errorCodeAndMsgDetails"),
	BUSINESS_VALIDATION(6),
	META_DATA_VALIDATION(4),
	R010("R010"),
	R219("R219"),
	USER_ROLE_LABEL_PROCEDURE("CALL SP_INSERT_USER_ROLE_LABEL(?)"),
	SADP_PORTAL_ID(1L),
	SADP_PORTAL_CODE("IFILE"),
	SP_INSERT_CUSTOM_ERROR_VERSION_CHANNEL_MAPPING("CALL SP_INSERT_CUSTOM_ERROR_VERSION_CHANNEL_MAPPING(?,?,?)"),
	EBR_BUSINESS_VALIDATION_PROCESS_CODE("EBR_BUSINESS_VALIDATION"),
	R179("R179"),
	R180("R180"),
	R329("R329"),
	DAYS_DIFF_14("R084,R148,R085"),
	R086("R086"),
	R069("R069"),
	DAYS_60(60),
	DAYS_250(250),
	...
	R268("R268"),
	VERTICAL_BAR("|"),
	NSDL_REJECTED("NSDL-REJECTED"),
	USER_REJECTED("USER-REJECTED"),
	NSDL_PENDING("NSDL-PENDING"),
	NSDL_APPROVED("NSDL-APPROVED"),
	USER_VERIFIED("USER-VERIFIED"),
	AGENCY_ROLE_TYPE_ID(5L),
	PENDING_NSDL_VERI_PAN_LIST_FETCHED_SUCCESSFULLY("PENDING_NSDL_VERI_PAN_LIST_FETCHED_SUCCESSFULLY"),
	NSDL_VERIFIED_PAN_INSERTED_SUCCESSFULLY("NSDL_VERIFIED_PAN_INSERTED_SUCCESSFULLY"),
	RBI_PAN_PROCESSED_SUCCESSFULLY("RBI_PAN_PROCESSED_SUCCESSFULLY"),
	FRAUD_CODE_INSERTED_SUCCESSFULLY("FRAUD_CODE_INSERTED_SUCCESSFULLY"),
	RBI_NSDL_PAN_MAP("RBI_NSDL_PAN_MAP"),
	PEND_NSDL_VERIFY("PEND_NSDL_VERIFY"),
	PEN_NSDL_VERIFY("PEND_NSDL_VERIFY"),
	GET_OTP_FOR_NBFC_REG("GET_OTP_FOR_NBFC_REG"),
	WHETHER_NIL_REPORTING("whetherNilReporting"),
	TRUE("true"),
	...
	COUNTRY_CODE_COUNTRY_NAME("countryCodeCountryName"),
	BRANCH_CODE("branchCode"),
	BRANCH_NAME("branchName"),
	BRANCH_CODE_BRANCH_NAME("branchCodeBranchName"),
	BRANCH_NAME_BRANCH_CODE("branchNameBranchCode"),
	STATE_CODE("stateCode"),
	STATE_NAME("stateName"),
	STATE_CODE_STATE_NAME("stateCodeStateName"),
	CURRENCY_CODE("currencyCode"),
	UNIT("unit"),
	RISK_TYPE("riskType"),
	JOINT_VENTURE_CODE("jointVentureCode"),
	JOINT_VENTURE_NAME("jointVentureName"),
	ACTIVITY_NAME("activityName"),
	REGULATOR_NAME("regulatorName"),
	JOINT_VENTURE_CATEGORY("jointVentureCategory"),
