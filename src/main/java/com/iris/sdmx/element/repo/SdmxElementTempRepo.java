...
public interface SdmxElementTempRepo extends JpaRepository<SdmxElementTempEntity, Long> {
	...
	@Query("update SdmxElementTempEntity u set u.sdmxStatusEntity.adminStatusId =:adminStatusId, u.comment =:comment " + "where u.elementTempId =:elementTempId")
	...
	@Query("from SdmxElementTempEntity u where u.dsdCode =:dsdCode and u.elementVer =:elementVer and " + "u.actionStatusFk.actionId =:actionId and u.sdmxStatusEntity.adminStatusId =:adminStatusId")
