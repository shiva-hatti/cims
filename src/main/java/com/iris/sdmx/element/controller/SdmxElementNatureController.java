...
public class SdmxElementNatureController {
	...
	public ServiceResponse fetchElementNature(@RequestHeader("JobProcessingId") String jobProcessId, @RequestHeader("IsActive") Boolean isActive, @PathVariable("userId") Long userId, @RequestBody SdmxElementNatureBean sdmxElementNatureBeans) {
		LOGGER.info("START - Fetch Element Nature by Active status request received with Job Processing ID : " + jobProcessId);
		...
		LOGGER.info("End - Fetch Element Nature by Active status request completed with Job Processing ID : " + jobProcessId);
