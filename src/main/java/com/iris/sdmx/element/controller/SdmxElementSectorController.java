...
public class SdmxElementSectorController {
	...
	public ServiceResponse fetchElementSector(@RequestHeader("JobProcessingId") String jobProcessId, @RequestHeader("IsActive") Boolean isActive, @PathVariable("userId") Long userId, @RequestBody SdmxElementSectorBean sdmxElementSectorBeans) {
		LOGGER.info("START - Fetch Element Sector by Active status request received with Job Processing ID : " + jobProcessId);
		...
		LOGGER.info("End - Fetch Element Sector by Active status request completed with Job Processing ID : " + jobProcessId);
