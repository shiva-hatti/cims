...
public class SdmxElementBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7940148093732310434L;
	 ...
	 * @param elementVer
	 */
	public SdmxElementBean(Long elementId, String dsdCode, String elementLabel, String elementVer) {
	...
	public void setDsdCode(String dsdCode) {
		this.dsdCode = dsdCode.toUpperCase();
	}
	...
	/**
	 * @param string the usageName to set
	 */
	public void setUsageName(String string) {
	...
	public String toString() {
		return "SdmxElementBean [elementId=" + elementId + ", dsdCode=" + dsdCode + ", elementLabel=" + elementLabel + ", elementVer=" + elementVer + ", classificationTypeId=" + classificationTypeId + ", classificationName=" + classificationName + ", dependencyTypeId=" + dependencyTypeId + ", dependencyTypeName=" + dependencyTypeName + ", flowTypeId=" + flowTypeId + ", flowTypeName=" + flowTypeName + ", natureTypeId=" + natureTypeId + ", natureTypeName=" + natureTypeName + ", sectorTypeId=" + sectorTypeId + ", sectorTypeName=" + sectorTypeName + ", elementDesc=" + elementDesc + ", elementParentId=" + elementParentId + ", parentElementVer=" + parentElementVer + ", parentElementDsdCode=" + parentElementDsdCode + ", isActive=" + isActive + ", lastUpdatedOn=" + lastUpdatedOn + ", createdBy=" + createdBy + ", createdByUserName=" + createdByUserName + ", createdOn=" + createdOn + ", modifyBy=" + modifyBy + ", modifyOn=" + modifyOn + ", modifyByUserName=" + modifyByUserName + ", ownerDepartmentId=" + ownerDepartmentId + ", ownerDepartmentCode=" + ownerDepartmentCode + ", ownerDepartmentName=" + ownerDepartmentName + "]";
	}
