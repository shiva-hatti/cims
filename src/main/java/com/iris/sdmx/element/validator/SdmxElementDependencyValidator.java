 ...
 */
@Component
public class SdmxElementDependencyValidator {

	private static final Logger LOGGER = LogManager.getLogger(SdmxElementDependencyValidator.class);
	...
	public void validateDependencyRequest(String jobProcessId, Long userId) throws ApplicationException {
