 ...
 */
@Component
public class SdmxElementNatureValidator {

	private static final Logger LOGGER = LogManager.getLogger(SdmxElementNatureValidator.class);
	...
	public void validateNatureRequest(String jobProcessId, Long userId) throws ApplicationException {
