 ...
 */
@Component
public class SdmxElementSectorValidator {

	private static final Logger LOGGER = LogManager.getLogger(SdmxElementSectorValidator.class);
	...
	public void validateSectorRequest(String jobProcessId, Long userId) throws ApplicationException {
