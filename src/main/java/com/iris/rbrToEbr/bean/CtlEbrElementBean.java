 ...
 *
 */
public class CtlEbrElementBean implements Serializable {
	 ...
	 */
	public void setControlFk(Long controlFk) {
	...
	public String toString() {
		return "CtlEbrElementBean [controlEbrElementId=" + controlEbrElementId + ", controlFk=" + controlFk + ", entityCode=" + entityCode + ", elementCode=" + elementCode + ", auditStatus=" + auditStatus + ", createdBy=" + createdBy + ", createdByUserName=" + createdByUserName + ", createdDate=" + createdDate + ", modifiedBy=" + modifiedBy + ", modifiedByUserName=" + modifiedByUserName + ", modifiedDate=" + modifiedDate + "]";
	}
