...
public class CityMasterController {
	...
	private List<CityMaster> prepareCityObject(List<CityMaster> listOfActiveCityData) {
		...
		for (CityMaster cityMaster : listOfActiveCityData) {
			CityMaster tempCityMaster = new CityMaster();
			tempCityMaster.setCityName(cityMaster.getCityName());
			tempCityMaster.setCityCode(cityMaster.getCityCode());
			tempCityMaster.setId(cityMaster.getId());
			tempCityMaster.setStdCode(cityMaster.getStdCode());
			DistrictMaster tempDistrictMaster = new DistrictMaster();
			StateMaster tempStateMaster = new StateMaster();
			tempStateMaster.setId(cityMaster.getDistrictIdFk().getStateIdFk().getId());
			tempStateMaster.setStateCode(cityMaster.getDistrictIdFk().getStateIdFk().getStateCode());
			tempStateMaster.setStateName(cityMaster.getDistrictIdFk().getStateIdFk().getStateName());
			tempDistrictMaster.setStateIdFk(tempStateMaster);
			tempCityMaster.setDistrictIdFk(tempDistrictMaster);
			...
			tempCityMaster.setPincode(listOfPincodeDataNew);
			cityMasterListNew.add(tempCityMaster);
		}
