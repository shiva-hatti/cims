...
public class CodeListMasterController {
	...
	private void validateInputRequestToFetchCodeListMasterData(String jobProcessingId, CodelListMasterRequestBean codeListMasterRequestBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterRequestBean.getUserId()) || UtilMaster.isEmpty(codeListMasterRequestBean.getRoleId()) || UtilMaster.isEmpty(codeListMasterRequestBean.getIsApprovedRecord())) {
	...
	private void validateInputRequestForRecordExistance(String jobProcessingId, CodelListMasterRequestBean codeListMasterRequestBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterRequestBean.getClCode()) || UtilMaster.isEmpty(codeListMasterRequestBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterRequestBean.getUserId()) || UtilMaster.isEmpty(codeListMasterRequestBean.getRoleId())) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	}
	...
	private void validateInputRequestForUserExit(String jobProcessingId, CodelListMasterRequestBean codeListMasterRequestBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterRequestBean.getUserId()) || UtilMaster.isEmpty(codeListMasterRequestBean.getRoleId())) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	}
	...
	private void validateInputRequestObjectForRecordDeletion(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 3) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	...
	private void validateInputRequestObjectForRecordUpdation(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getClCode()) || UtilMaster.isEmpty(codeListMasterBean.getClId()) || UtilMaster.isEmpty(codeListMasterBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 2) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	...
	private void validateInputRequestObjectForRecordAddition(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		...
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getClCode()) || UtilMaster.isEmpty(codeListMasterBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 1) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	...
	private void validateInputRequestObjectForDeletedRecordApproval(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getClCode()) || UtilMaster.isEmpty(codeListMasterBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 3 || UtilMaster.isEmpty(codeListMasterBean.getIsApproved())) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	}
	...
	private void validateInputRequestObjectForEditedRecordApproval(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getClCode()) || UtilMaster.isEmpty(codeListMasterBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 2 || UtilMaster.isEmpty(codeListMasterBean.getIsApproved())) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	}
	...
	private void validateInputRequestObjectForAddedRecordApproval(String jobProcessingId, CodeListMasterBean codeListMasterBean) throws ApplicationException {
		if (UtilMaster.isEmpty(jobProcessingId) || UtilMaster.isEmpty(codeListMasterBean.getClCode()) || UtilMaster.isEmpty(codeListMasterBean.getClVersion()) || UtilMaster.isEmpty(codeListMasterBean.getUserId()) || UtilMaster.isEmpty(codeListMasterBean.getRoleId()) || codeListMasterBean.getActionId() != 1 || UtilMaster.isEmpty(codeListMasterBean.getIsApproved())) {
			throw new ApplicationException(ErrorCode.E0889.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E0889.toString()));
		}
	}
