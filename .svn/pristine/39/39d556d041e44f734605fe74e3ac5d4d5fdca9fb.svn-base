...
public class ConceptScheme implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2502426476219309269L;
	...
	private List<ConceptScheme> items;
	 ...
	 * @return the items
	 */
	public List<ConceptScheme> getItems() {
		return items;
	}
	 ...
	 */
	public void setItems(List<ConceptScheme> items) {
		this.items = items;
	}
}
