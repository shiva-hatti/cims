...
public class DateValidationsController implements Serializable {
	...
	/**
	 * This method is used for fetch existing dates for filling window for annual,half yearly,quarterly
	 * 
	 * @author Mohd Arshil A Shaikh
	 * @since 13-10-2014
	 * @param Dates map based for all frequency, All the extension list , year, financial year id , form frequency id list
	...
	public Map<Long, Map<Long, FillingEndDatesBean>> getFillingWindow(Long freqId, Integer exensionDays, String endDate, List<Holiday> holidayList, boolean isIncludeHoliday, boolean isIncludeWeekend, Integer graceDays) {
	...
	public Map<String, Map<Integer, String>> getFillingWindowDaily(List<Integer> fillingWindowExtensionList, List<Integer> fillingWindowEndExtensionList, String financialDateForDaily, List<Holiday> holidayList, boolean isIncludeHoliday, boolean isIncludeWeekend, String financialMonth, String year) {
	...
	/**
	 * This method is used for fetch existing dates for filling window for monthly
	 * 
	 * @author Mohd Arshil A Shaikh
	 * @param isIncludeWeekend
	 * @param isIncludeHoliday
	 * @since 15-10-2014
	 * @param All the extension list , End Date of selected Month , year, financial year id
	 * @return Map with extension as key and object of date as values
	 */
	...
	/**
	 * This method is used for fetch existing dates for filling window for fortnightly
	 * 
	 * @author Mohd Arshil A Shaikh
	 * @param isIncludeWeekend
	 * @param isIncludeHoliday
	 * @since 16-10-2014
	 * @param All the extension list , End Date of fortnight dates in selected month
	 * @return Map with extension as key and object of date as values
	 */
	...
	/**
	 * This method is used for fetch existing dates for filling window for weekly
	 * 
	 * @author Mohd Arshil A Shaikh
	 * @since 16-10-2014
	 * @param All the extension list , End Date of selected weekly in selected month
	 * @return Map with extension as key and object of date as values
	 */
	 ...
	 * @author Mohd Arshil A Shaikh
	 * @since 25-10-2014
	 * @param list of financial year frequency
	 * @return Map with frequency and type of fin year as key and dates bean obj as value
	 */
	 ...
	 * @author Mohd Arshil A Shaikh
	 * @since 27-10-2014
	 * @param input date, format of date , number of days to add
	 * @return result date
	 */
	public String addDate(String date, String dateFormat, int daysToAdd, List<Holiday> holidayList, boolean isIncludeHoliday, boolean isIncludeWeekend) {
		...
		try {
			...
			for (Holiday holidayListObj : holidayList) {
				holidayListPassed.add(DateManip.formatDate(holidayListObj.getHolidayDate().toString().substring(0, 10), DateConstants.YYYY_MM_DD.getDateConstants(), DateConstants.DD_MM_YYYY.getDateConstants()));
			}
	 ...
	 * @param outFormat   The output date format
	 ...
	 * @param dateFormat The format of the given dates
	 ...
	 * @param dateFormat The date value
