...
public class ApprovalController {
	...
	public ServiceResponse getPendingRecords(String jobProcessId, UserDto userDto, List<ReturnGroupMappingDto> inputReturnList, List<EntityBean> inputEntityList) {
		try {
	...
	public ServiceResponse approveRejectRecords(@RequestHeader(name = "JobProcessingId") String jobProcessId, @RequestBody ReturnApprovalDataDto returnApprovalDataDto) {
		try {
