 ...
 *
 */
public class SdmxEditElementInputBean implements Serializable {
	...
	public void setElementLabel(String elementLabel) {
		this.elementLabel = SdmxValidations.trimInput(elementLabel);
	}
	...
	public void setOwnerDepartmentCode(String ownerDepartmentCode) {
		this.ownerDepartmentCode = SdmxValidations.trimInput(ownerDepartmentCode);
	}
	...
	public void setParentElementDsdCode(String parentElementDsdCode) {
		this.parentElementDsdCode = SdmxValidations.trimInput(parentElementDsdCode);
	}
	...
	public void setParentElementVer(String parentElementVer) {
		this.parentElementVer = SdmxValidations.trimInput(parentElementVer);
	}
	...
	public void setElementDesc(String elementDesc) {
		this.elementDesc = SdmxValidations.trimInput(elementDesc);
	}
	...
	public String toString() {
		return "SdmxEditElementInputBean [elementLabel=" + elementLabel + ", classificationTypeId=" + classificationTypeId + ", flowTypeId=" + flowTypeId + ", natureTypeId=" + natureTypeId + ", dependencyTypeId=" + dependencyTypeId + ", sectorTypeId=" + sectorTypeId + ", ownerDepartmentCode=" + ownerDepartmentCode + ", parentElementDsdCode=" + parentElementDsdCode + ", parentElementVer=" + parentElementVer + ", elementDesc=" + elementDesc + ", roleId=" + roleId + "]";
	}
