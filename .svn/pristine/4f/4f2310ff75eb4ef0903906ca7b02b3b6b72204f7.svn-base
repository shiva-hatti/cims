 ...
 */
@Component
public class SdmxElementBeanForTemp {
	...
	public String toString() {
		return "SdmxElementBeanForTemp [elementId=" + elementId + ", dsdCode=" + dsdCode + ", elementLabel=" + elementLabel + ", elementVer=" + elementVer + ", classificationTypeId=" + classificationTypeId + ", classificationName=" + classificationName + ", flowTypeId=" + flowTypeId + ", flowTypeName=" + flowTypeName + ", natureTypeId=" + natureTypeId + ", natureTypeName=" + natureTypeName + ", dependencyTypeId=" + dependencyTypeId + ", dependencyTypeName=" + dependencyTypeName + ", sectorTypeId=" + sectorTypeId + ", sectorTypeName=" + sectorTypeName + ", elementDesc=" + elementDesc + ", elementParentId=" + elementParentId + ", parentElementVer=" + parentElementVer + ", parentElementDsdCode=" + parentElementDsdCode + ", ownerDepartmentId=" + ownerDepartmentId + ", ownerDepartmentCode=" + ownerDepartmentCode + ", ownerDepartmentName=" + ownerDepartmentName + "]";
	}
}
