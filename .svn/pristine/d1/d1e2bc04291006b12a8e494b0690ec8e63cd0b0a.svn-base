...
public class SdmxDataModelCodesDownloadController {
	...
	public ServiceResponse getAllSDMXPublishTemplate(@RequestHeader(name = "JobProcessingId") String jobProcessId, @RequestBody SdmxModelCodesDownloadBean sdmxModelCodesDownloadBean) {
		...
		try {
			...
			List<SdmxModelCodesDownloadBean> sdmxModelCodesDownloadBeans = sdmxModelCodesDownloadService.fetchPublishTemplate(sdmxModelCodesDownloadBean.getReturnIdList(), jobProcessId, sdmxModelCodesDownloadBean.isCheckForDataFilteration());
