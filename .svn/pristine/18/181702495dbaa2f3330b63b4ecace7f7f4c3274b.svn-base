...
public class SdmxMenuService implements GenericService<SdmxMenu, Long> {
	...
	@Override
	public List<SdmxMenu> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<SdmxMenu> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<SdmxMenu> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<SdmxMenuBean> getMenuAccessList(String jobProcessId, MenuAccessInputBean menuAccessInputBean, String langCode) {
		...
		if (menuAccessInputBean.getRoleTypeId() != null) {
			...
			SdmxMenuEntityList = sdmxMenuRepo.getRoleTypeWiseActiveMenus(menuAccessInputBean.getRoleTypeId(), menuAccessInputBean.getIsAdmin(), menuAccessInputBean.getIsMainDept());
