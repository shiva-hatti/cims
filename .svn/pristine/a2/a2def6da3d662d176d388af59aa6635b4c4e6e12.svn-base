		...
		if (file != null) {
			try (FileInputStream fileInputStream = new FileInputStream(file);) {
				...
				if (fileMimeType != null) {
					...
					} else if (fileMimeType.equals(GeneralConstants.PDFMIMETYPE.getConstantVal())) {
						fileMimeTypeDetails = new String[2];
						fileMimeTypeDetails[0] = GeneralConstants.PDF.getConstantVal();
						fileMimeTypeDetails[1] = GeneralConstants.PDFMIMETYPE.getConstantVal();
					} else {
