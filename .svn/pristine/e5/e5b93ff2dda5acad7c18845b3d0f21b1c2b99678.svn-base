...
public class GroupMasterBulkService implements GenericService<GroupMasterBulk, Long> {
	...
	@Override
	public List<GroupMasterBulk> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
		try {
	...
	@Override
	public List<GroupMasterBulk> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<GroupMasterBulk> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		try {
