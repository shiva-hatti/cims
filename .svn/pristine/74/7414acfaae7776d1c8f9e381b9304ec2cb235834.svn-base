...
@Component
public class SdmxElementRegulatorValidator {

	private static final Logger LOGGER = LogManager.getLogger(SdmxElementRegulatorValidator.class);
	...
	public void validateRegulatorRequest(String jobProcessId, Long userId) throws ApplicationException {
