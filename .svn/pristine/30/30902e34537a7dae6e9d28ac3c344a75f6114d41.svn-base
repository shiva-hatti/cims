...
public class SdmxElementValidator {
	 ...
	 * 
	 */
	public void validateAddElementRequest(SdmxAddElementInputBean sdmxAddElementInputBean, String jobProcessId, SdmxElementBeanForTemp sdmxElementBeanForTemp, Long userId) throws ApplicationException {
		...
		validateUsageId(sdmxAddElementInputBean.getUsageId(), sdmxElementBeanForTemp);

		validateFrequencyId(sdmxAddElementInputBean.getFrequencyId(), sdmxElementBeanForTemp);
		...
		validateParentElement(sdmxAddElementInputBean.getParentElementDsdCode(), sdmxAddElementInputBean.getParentElementVer(), sdmxAddElementInputBean.getAgencyMasterCode(), sdmxElementBeanForTemp);
	 ...
	 */
	public void validateEditElementRequest(SdmxEditElementInputBean sdmxEditElementInputBean, String jobProcessId, Long userId, SdmxElementBeanForTemp sdmxElementBeanForTemp, Long elementId) throws ApplicationException {
		...
		validateUsageId(sdmxEditElementInputBean.getUsageId(), sdmxElementBeanForTemp);

		validateFrequencyId(sdmxEditElementInputBean.getFrequencyId(), sdmxElementBeanForTemp);

		validateUser(userId, sdmxElementBeanForTemp);

		validateRegulator(sdmxEditElementInputBean.getOwnerDepartmentCode(), sdmxElementBeanForTemp);

		validateParentElement(sdmxEditElementInputBean.getParentElementDsdCode(), sdmxEditElementInputBean.getParentElementVer(), sdmxEditElementInputBean.getAgencyMasterCode(), sdmxElementBeanForTemp);
	...
	private void validateElementId(Long elementId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (elementId == null) {
	 ...
	 * @throws ApplicationException
	 */
	public void validateDeleteElementRequest(Long elementId, Long userId, String jobProcessId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	public void validateFetchElementsRequest(Long userId, String jobProcessId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	public void validateFetchElementByIdRequest(String elementId, String userId, String jobProcessId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @param elementVer
	 */
	private void validateElementVersion(String elementVer, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private void validateElementDescription(String elementDesc, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private void validateParentElement(String parentElementDsdCode, String parentElementVer, String agencyCode, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (!StringUtils.isBlank(parentElementDsdCode) && !StringUtils.isBlank(parentElementVer)) {
			Long elementId = sdmxElementService.findByDsdCodeAndVerAndIsActive(parentElementDsdCode, parentElementVer, true, agencyCode);
			if (elementId == null) {
	 ...
	 * @throws ApplicationException
	 */
	private void validateRegulator(String ownerDepartmentCode, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private static void validateElementLabel(String elementLabel, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private void validateClassificationType(Long classificationTypeId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (classificationTypeId == null) {
			throw new ApplicationException("ER005", "Classification type can't Blank");
		} else {
			String classificationName = sdmxElementClassificationService.findNameByClassificationId(classificationTypeId);
	 ...
	 * @throws ApplicationException
	 */
	private void validateFlowTypeId(Long flowTypeId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (flowTypeId == null) {
	 ...
	 * @throws ApplicationException
	 */
	private void validateNatureTypeId(Long natureTypeId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private void validateSectorTypeId(Long sectorTypeId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	 ...
	 * @throws ApplicationException
	 */
	private void validateDependencyTypeId(Long dependencyTypeId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
	...
	private void validateDsdCodeExistOrNot(String dsdCode, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		Long statusCodeId = adminStatusService.findIdByStatusTechCode(SDMXConstants.StatusTechCode.PENDING_FOR_APPROVAL.getCode());
		if (sdmxElementTempService.isDataExistWithDsdCodeAndStatus(dsdCode, new AdminStatus(statusCodeId))) {
			throw new ApplicationException("ER015", "Another request is already in progress with this DSD code. Can't proceed that request");
		} else {
	...
	public void validatePendingAddRequestPresent(String dsdCode, String elementVersion) throws ApplicationException {
		...
		if (!UtilMaster.isEmpty(sdmxElementTempEntity)) {
			throw new ApplicationException("ERROR", "Another add request is already in progress with this DSD code and version. Can't proceed that request");
		}

	}

	private void validateUsageId(Long usageId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (usageId == null) {
			throw new ApplicationException(ErrorCode.E1255.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E1255.toString()));
		} else {
			String usageName = sdmxElementUsageService.findNameByUsageId(usageId);
			if (StringUtils.isBlank(usageName)) {
				throw new ApplicationException(ErrorCode.E1257.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E1257.toString()));
			} else {
				sdmxElementBeanForTemp.setUsageId(usageId);
				sdmxElementBeanForTemp.setUsageName(usageName);
			}
		}
	}

	private void validateFrequencyId(Long frequencyId, SdmxElementBeanForTemp sdmxElementBeanForTemp) throws ApplicationException {
		if (frequencyId == null) {
			throw new ApplicationException(ErrorCode.E1256.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E1256.toString()));
		} else {
			String frequencyName = sdmxElementFrequencyService.findNameByFrequencyId(frequencyId);
			if (StringUtils.isBlank(frequencyName)) {
				throw new ApplicationException(ErrorCode.E1258.toString(), ObjectCache.getErrorCodeKey(ErrorCode.E1258.toString()));
			} else {
				sdmxElementBeanForTemp.setFrequencyId(frequencyId);
				sdmxElementBeanForTemp.setFrequencyName(frequencyName);
			}
		}
	}
