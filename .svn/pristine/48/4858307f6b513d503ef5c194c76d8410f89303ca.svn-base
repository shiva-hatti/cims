...
public class SdmxElementController {
	...
	public ServiceResponse addElement(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxAddElementInputBean sdmxAddElementInputBean, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode) {
		...
		try {
			...
			sdmxElementValidator.validateAddElementRequest(sdmxAddElementInputBean, jobProcessId, sdmxElementBeanForTemp, userId);

			sdmxElementControllerService.addElement(sdmxAddElementInputBean, jobProcessId, sdmxElementBeanForTemp, userId);
	...
	public ServiceResponse editElement(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxEditElementInputBean sdmxEditElementInputBean, @PathVariable("elementId") Long elementId, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode) {
		...
		try {
			...
			sdmxElementValidator.validateEditElementRequest(sdmxEditElementInputBean, jobProcessId, userId, sdmxElementBeanForTemp, elementId);
			sdmxElementControllerService.editElement(sdmxEditElementInputBean, jobProcessId, sdmxElementBeanForTemp, userId);
			ebrMetadataFlowService.ctlEntryForEbrMetadata(EbrMetadataFlowContstant.ELEMENT.getConstantVal());
			serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
			serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
		} catch (ApplicationException applicationException) {
	...
	public ServiceResponse deleteElement(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("elementId") Long elementId) {
	...
	public ServiceResponse deleteElement(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestHeader("ElementIds") String elementIds, @RequestHeader("deleteApproval") String deleteApproval, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode) {
		...
		if (!StringUtils.isBlank(elementIds)) {
			...
			for (String elementIdStr : elementIdArray) {
				...
				try {
					...
					LOGGER.error(ErrorConstants.ERROR_MSG_SERVICE.getConstantVal() + "Job Processing ID : " + jobProcessId, e);
					isRecordFail = true;
					serviceResponseBuilderChild = new ServiceResponseBuilder().setStatus(false).setStatusCode(ErrorCode.EC0013.toString()).setStatusMessage(ObjectCache.getErrorCodeKey(ErrorCode.EC0013.toString())).setResponse(elementIdStr);
				}
	...
	public ServiceResponse fetchElementById(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") String userId, @PathVariable("elementId") String elementId) {
		...
		SdmxElementBeanForTemp sdmxElementBeanForTemp = new SdmxElementBeanForTemp();
		try {
			sdmxElementValidator.validateFetchElementByIdRequest(elementId, userId, jobProcessId, sdmxElementBeanForTemp);
			SdmxElementBean sdmxElementBean = sdmxElementService.findEntityByActiveStatus(Long.parseLong(elementId), true);
	...
	public ServiceResponse fetchElementList(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode) {
	...
	public ServiceResponse fetchElementListWthAgency(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode, @PathVariable("agencyCode") String agencyCode) {
		LOGGER.info("START - Fetch Element List request received with Job Processing ID : " + jobProcessId);
		ServiceResponse serviceResponse = null;
		ServiceResponseBuilder serviceResponseBuilder = new ServiceResponseBuilder();
		serviceResponseBuilder.setStatus(true);
	...
	public ServiceResponse fetchElementListWithPendingStatus(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode) {
		LOGGER.info("START - Fetch Element List request received with Job Processing ID : " + jobProcessId);
		ServiceResponse serviceResponse = null;
		ServiceResponseBuilder serviceResponseBuilder = new ServiceResponseBuilder();
		serviceResponseBuilder.setStatus(true);
	...
	@GetMapping("/user/{userId}/role/{roleId}/lang/{langCode}/agency/{agencyCode}/elementsByStatusNAgency")
	public ServiceResponse fetchElementListWithPendingStatus(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable(name = "roleId") Long roleId, @PathVariable("langCode") String langCode, @PathVariable("agencyCode") String agencyCode) {
		LOGGER.info("START - Fetch Element List request received with Job Processing ID : " + jobProcessId);
		ServiceResponse serviceResponse = null;
		ServiceResponseBuilder serviceResponseBuilder = new ServiceResponseBuilder();
		serviceResponseBuilder.setStatus(true);
		...
		try {
			sdmxElementValidator.validateFetchElementsRequest(userId, jobProcessId, sdmxElementBeanForTemp);
			List<SdmxElementBean> sdmxElementBeans = sdmxElementService.findEntitiesByActiveStatusNAgencyCode(true, false, agencyCode);
			serviceResponseBuilder.setResponse(sdmxElementBeans);
			serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
			serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
		} catch (ApplicationException applicationException) {
	...
	public ServiceResponse getElementDimensionReturnDetail(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody List<SdmxElementRequestMappingBean> requestBeanList, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode) {
	...
	public ServiceResponse isElementExist(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("elementCode") String elementCode, @PathVariable("elementVersion") String elementVersion, @PathVariable("agencyMasterCode") String agencyMasterCode, @RequestBody SdmxElementExistBean sdmxElementExistBean) {
		...
		try {
			...
			// elementVersion, true);
			SdmxElementExistBean SdmxElementExist = sdmxElementService.chkElementExist(elementCode, elementVersion, Boolean.TRUE, agencyMasterCode);
			serviceResponseBuilder.setStatus(true);
	...
	public ServiceResponse isElementExistCheck(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("elementCode") String elementCode, @PathVariable("elementVersion") String elementVersion, @PathVariable("agencyMasterCode") String agencyMasterCode, @RequestBody SdmxElementExistBean sdmxElementExistBean) {
		LOGGER.info("START - Check if Element exist request received with Job Processing ID : " + jobProcessId);
		ServiceResponse serviceResponse = null;
		ServiceResponseBuilder serviceResponseBuilder = new ServiceResponseBuilder();
		serviceResponseBuilder.setStatus(true);
		try {
			sdmxElementValidator.validateViewMappingDetailRequest(userId, jobProcessId);
			serviceResponseBuilder.setStatus(true);
			serviceResponseBuilder.setResponse(sdmxElementService.isElementExist(elementCode, elementVersion, Boolean.TRUE, agencyMasterCode));
	...
	public ServiceResponse isElementPending(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("elementCode") String elementCode, @PathVariable("elementVersion") String elementVersion, @PathVariable("agencyMasterCode") String agencyMasterCode, @RequestBody SdmxElementExistBean sdmxElementExistBean) {
		...
		try {
			sdmxElementValidator.validateViewMappingDetailRequest(userId, jobProcessId);
			serviceResponseBuilder.setStatus(true);
			serviceResponseBuilder.setResponse(sdmxElementService.isElementPending(elementCode, elementVersion, Boolean.TRUE, agencyMasterCode));
