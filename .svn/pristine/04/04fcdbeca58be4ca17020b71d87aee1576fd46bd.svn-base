...
public class SdmxFusionDsdDetailService implements GenericService<SdmxFusionDsdDetailEntity, Long> {
	...
	@Override
	public List<SdmxFusionDsdDetailEntity> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<SdmxFusionDsdDetailEntity> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<SdmxFusionDsdDetailEntity> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}
	 ...
	 * @return
	 */
	public String findMaxVersionActiveStatus(boolean isActive, Long agencyMasterId) {
		return sdmxFusionDsdDetailRepo.findMaxVersionActiveStatus(isActive, agencyMasterId);
	}
