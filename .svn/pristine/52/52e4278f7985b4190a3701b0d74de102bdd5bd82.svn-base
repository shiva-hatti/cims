 ...
 *
 */
public class SdmxFusionDsdDetailBean implements Serializable {
	...
	private String fusionAgencyName;
	...
	/**
	 * @return the fusionAgencyName
	 */
	public String getFusionAgencyName() {
		return fusionAgencyName;
	}

	/**
	 * @param fusionAgencyName the fusionAgencyName to set
	 */
	public void setFusionAgencyName(String fusionAgencyName) {
		this.fusionAgencyName = fusionAgencyName;
	}
