...
public class SdmxReturnModelInfoController {
	...
	public ServiceResponse fetchMapCellRefByReturnTemplateId(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("returnTemplateIdFk") Long returnTemplateIdFk, @PathVariable("returnPreviewId") Long returnPreviewId) {
		...
		try {
			...
			List<SdmxReturnModelInfoBean> mappedCellRefList = sdmxReturnModelInfoService.fetchMapCellRefByReturnTemplateId(returnTemplateIdFk, returnPreviewId);
	...
	public ServiceResponse fetchFormulaBuilder(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("returnPreviewId") Long returnPreviewId) {
		LOGGER.info("START - Fetch Return Preview request received with Job Processing ID : " + jobProcessId);
		ServiceResponse serviceResponse = null;
		ServiceResponseBuilder serviceResponseBuilder = new ServiceResponseBuilder();
		serviceResponseBuilder.setStatus(true);
		try {
			...
			List<ReturnFormulaBean> formulaBuilderJsonList = sdmxReturnModelInfoService.fetchFormulaBuilderJson(returnPreviewId);
