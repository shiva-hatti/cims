...
public class SdmxLockRecordController implements Serializable {
	...
	public ServiceResponse setLockOnRecord(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxLockRecordSetBean sdmxLockRecordSetBean) {
		...
		try {
			...
			String recordDetailEncodedStr = SdmxLockRecordHelper.sortingNBase64FromRecordDetailJsonString(sdmxLockRecordSetBean.getRecordDetailEncodedJson(), jobProcessId);

			// Check Lock Status
			SdmxLockRecordBean sdmxLockRecordBean = sdmxLockRecordService.findByRecordDetailEncode(recordDetailEncodedStr, jobProcessId);
			...
			// Save lock record
			sdmxLockRecordService.setLockOnRecord(sdmxLockRecordSetBean, jobProcessId, userId, recordLockId, recordDetailEncodedStr);
	...
	public ServiceResponse updateLockOnRecordStatus(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxLockRecordStatusCheckBean sdmxLockRecordStatusCheckBean) {
		...
		try {
			// Validation
			sdmxLockRecordValidator.validateCheckLockRecordStatus(userId, jobProcessId, sdmxLockRecordStatusCheckBean.getRecordDetailEncodedJson());

			// Sorting and Base 64 conversion
			String recordDetailEncodedStr = SdmxLockRecordHelper.sortingNBase64FromRecordDetailJsonString(sdmxLockRecordStatusCheckBean.getRecordDetailEncodedJson(), jobProcessId);

			// Check Lock Status
			sdmxLockRecordService.findNSaveByRecordDetailEncodeNActive(recordDetailEncodedStr, Boolean.TRUE, userId, jobProcessId);
			serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
			serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
		} catch (ApplicationException applicationException) {
			LOGGER.error(ErrorConstants.ERROR_MSG_SERVICE.getConstantVal() + "Job Processing ID : " + jobProcessId, applicationException);
	...
	public ServiceResponse checkLockRecordStatus(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxLockRecordStatusCheckBean sdmxLockRecordStatusCheckBean) {
		...
		try {
			...
			// Check Lock Status
			SdmxLockRecordBean sdmxLockRecordBean = sdmxLockRecordService.findByRecordDetailEncodeNActive(recordDetailEncodedStr, Boolean.TRUE, jobProcessId);
			// Response
			if (sdmxLockRecordBean != null) {
				serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
				serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
	...
	public ServiceResponse returnTemplateLockCheck(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @RequestBody SdmxReturnTemplateLockCheck sdmxReturnTemplateLockCheck) {
		...
		try {
			...
			if (uploadedReturnPreviewId != null && relativeReturnPreviewId == null) {
				...
				isReturnCellRefLocked = sdmxLockRecordService.isReturnCellRefLocked(Long.parseLong(sdmxReturnTemplateLockCheck.getUploadedReturnPreviewId()), Long.parseLong(sdmxReturnTemplateLockCheck.getCellRef()));
				if (isReturnCellRefLocked) {
					serviceResponseBuilder.setStatusCode(SDMXConstants.FAILURE_CODE);
					serviceResponseBuilder.setStatusMessage(SDMXConstants.FAILURE_MESSAGE);
					serviceResponseBuilder.setResponse(ObjectCache.getErrorCodeKey(ErrorCode.E1532.toString()));
				} else {
					serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
					serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
				...
				isReturnLocked = sdmxLockRecordService.isReturnTemplateLocked(Long.parseLong(sdmxReturnTemplateLockCheck.getUploadedReturnTemplateModule()), Long.parseLong(sdmxReturnTemplateLockCheck.getRelativeReturnTemplateId()), Long.parseLong(sdmxReturnTemplateLockCheck.getRelativeReturnPreviewId()));
				if (!isReturnLocked) {
					if (!StringUtils.isBlank(sdmxReturnTemplateLockCheck.getRelativeReturnTemplateModule())) {
						isReturnLocked = sdmxLockRecordService.isReturnTemplateLocked(Long.parseLong(sdmxReturnTemplateLockCheck.getRelativeReturnTemplateModule()), Long.parseLong(sdmxReturnTemplateLockCheck.getRelativeReturnTemplateId()), Long.parseLong(sdmxReturnTemplateLockCheck.getRelativeReturnPreviewId()));
						if (!isReturnLocked) {
							serviceResponseBuilder.setStatusCode(SDMXConstants.SUCCESS_CODE);
							serviceResponseBuilder.setStatusMessage(SDMXConstants.SUCCESS_MESSAGE);
							...
							serviceResponseBuilder.setStatusCode(SDMXConstants.FAILURE_CODE);
							serviceResponseBuilder.setStatusMessage(SDMXConstants.FAILURE_MESSAGE);
							serviceResponseBuilder.setResponse(ObjectCache.getErrorCodeKey(ErrorCode.E1535.toString()));
					...
					serviceResponseBuilder.setStatusCode(SDMXConstants.FAILURE_CODE);
					serviceResponseBuilder.setStatusMessage(SDMXConstants.FAILURE_MESSAGE);
					serviceResponseBuilder.setResponse(ObjectCache.getErrorCodeKey(ErrorCode.E1534.toString()));
				...
				serviceResponseBuilder.setStatusCode(SDMXConstants.FAILURE_CODE);
				serviceResponseBuilder.setStatusMessage(SDMXConstants.FAILURE_MESSAGE);
				serviceResponseBuilder.setResponse(ObjectCache.getErrorCodeKey(ErrorCode.EC0013.toString()));
	...
	public ServiceResponse releaseMultipleCellRefLock(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode, @RequestBody SdmxLockRecordStatusCheckBean sdmxLockRecordStatusCheckBean) {
		...
		try {
			...
			//getting map
			Gson gson = new Gson();
			SortedMap<String, Long> retMap = gson.fromJson(new String(Base64.decodeBase64(sdmxLockRecordStatusCheckBean.getRecordDetailEncodedJson())), new TypeToken<TreeMap<String, Long>>() {
			}.getType());
	...
	public ServiceResponse getCellRefLockLogs(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode, @PathVariable("returnPreviewId") Long returnPreviewId) {
		...
		try {
			...
			if (!cellRefLockLogsBeanList.isEmpty()) {
				...
				LOGGER.debug("Job Processing id - " + jobProcessId + ", @getCellRefLockLogs no logs found");
	...
	public ServiceResponse getModuleWiseLocks(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode, @PathVariable("moduleId") Long moduleId) {
	...
	public ServiceResponse releaseModuleWiseLocks(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode, @PathVariable("moduleId") Long moduleId, @RequestBody List<Long> lockRecordIdList) {
		...
		try {
			...
			if (!lockRecordIdList.isEmpty()) {
				...
				LOGGER.debug("Job Processing id - " + jobProcessId + ", lock record list is empty");
			}
	...
	public ServiceResponse getReturnInfo(@RequestHeader("JobProcessingId") String jobProcessId, @PathVariable("userId") Long userId, @PathVariable("roleId") Long roleId, @PathVariable("langCode") String langCode, @RequestBody List<Long> templateIdList) {
