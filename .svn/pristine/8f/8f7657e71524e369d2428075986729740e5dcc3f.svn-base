...
public interface ElementDimensionModRepo extends JpaRepository<ElementDimensionMod, Long> {
	...
	@Query("from ElementDimensionMod e where  e.adminStatusId =:adminStatusId and  e.element.dsdCode =:dsdCode and  e.element.elementVer =:version and " + "e.element.agencyMaster.agencyMasterCode =:agencyCode")
