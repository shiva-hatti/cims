...
public class WebformToCsvConversionController {
	...
	public ServiceResponse webFormToCsvConversion(@RequestHeader(name = "JobProcessingId") String jobProcessId, @RequestBody WebFormToCsvConversionDto webFormToCsvConversionDto) throws IOException {
		...
		String csvFileName = returnCode + CsvConversionConstants.UNDERSCORE.getConstantVal() + CsvConversionConstants.CSV_FILE_TEXT.getConstantVal() + CsvConversionConstants.UNDERSCORE.getConstantVal() + returnTemplate.getVersionNumber() + CsvConversionConstants.TXT_EXT.getConstantVal();

		String absolutePathToSaveFile = pathToSaveFile + csvFileName;

		String pathToSaveMetaInfoFile = pathToSaveFile + returnCode + CsvConversionConstants.UNDERSCORE.getConstantVal() + CsvConversionConstants.META_INFO_FILE_TEXT.getConstantVal() + CsvConversionConstants.UNDERSCORE.getConstantVal() + returnTemplate.getVersionNumber() + CsvConversionConstants.TXT_EXT.getConstantVal();

		returnTemplate.setTaxonomyName(csvFileName);
