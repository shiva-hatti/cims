...
public class ReturnEntityMapServiceNew implements GenericService<ReturnEntityMappingNew, Long> {
	...
	public List<ReturnEntityQueryOutputDto> fetchReturnByEntityCode(Long entityId, ReturnEntityMapDto returnChannelMapReqDto) {
		String returnQuerySql = "SELECT new com.iris.dto.ReturnEntityQueryOutputDto(remn.returnObj.returnId,remn.returnObj.returnCode, " + "returnLabel.returnLabel, " + "remn.entity.entityCode, remn.entity.entityName, " + "remn.returnObj.frequency.frequencyCode, remn.returnObj.frequency.frequencyName, fieldKeyLabel.fieldKeyLable, " + "remn.returnObj.returnGroupMapIdFk.returnGroupMapId,rglm.groupLabel, " + "remn.entity.category.categoryCode, remn.entity.category.categoryName," + "remn.entity.subCategory.subCategoryCode, remn.entity.subCategory.subCategoryName, remn.uploadChannel, remn.webChannel, remn.emailChannel, remn.apiChannel, remn.stsChannel, returnRegMapping.regulatorIdFk.regulatorId, returnRegMapping.regulatorIdFk.regulatorCode, returnRegMapping.regulatorIdFk.regulatorName, remn.returnObj.isNonXbrl, remn.returnObj.isApplicableForDynamicWebForm) " + "FROM ReturnEntityMappingNew remn, ReturnLabel returnLabel, ReturnRegulatorMapping returnRegMapping, " + "ReturnGroupLabelMapping rglm, FieldKey fieldKey, FieldKeyLabel fieldKeyLabel " + "WHERE remn.entity.entityId=:entityId " + "and remn.returnObj.returnId=returnLabel.returnIdFk.returnId " + "and returnLabel.langIdFk.languageCode=:langCode " + "and remn.isActive=:isActive " + "and remn.returnObj.isActive=:isActive " + "and remn.returnObj.returnGroupMapIdFk.isActive=:isActive " + "and remn.returnObj.frequency.isActive=:isActive " + "and remn.returnObj.returnGroupMapIdFk.returnGroupMapId=rglm.returnGroupMapIdFk.returnGroupMapId " + "and rglm.langIdFk.languageCode=:langCode and returnRegMapping.returnIdFk.returnId = remn.returnObj.returnId " + " and returnRegMapping.isActive =:isActive and returnRegMapping.regulatorIdFk.isActive =:isActive ";
