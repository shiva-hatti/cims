...
public class MISPendingMailSentHistService implements GenericService<MISPendingMailSentHist, Long> {
	...
	@Override
	public List<MISPendingMailSentHist> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
			...
			for (String columnName : columnValueMap.keySet()) {
				if (columnValueMap.get(columnName) != null && !columnValueMap.get(columnName).isEmpty()) {
					if (columnName.equalsIgnoreCase(ColumnConstants.RETURN_ID_LIST.getConstantVal())) {
						...
						conRetCodeList = returnIdList.stream().distinct().collect(Collectors.toList());
						...
						conEntCodeList = entityIdList.stream().distinct().collect(Collectors.toList());
						...
						List<String> distinctElements = tempEndDateList.stream().distinct().collect(Collectors.toList());
	...
	@Override
	public List<MISPendingMailSentHist> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public List<MISPendingMailSentHist> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		// TODO Auto-generated method stub
		return null;
	}
