...
public class NbfcCertificationDetailsService implements GenericService<NbfcCertificationDetails, Long> {
	...
	@Override
	public List<NbfcCertificationDetails> getDataByColumnValue(Map<String, List<String>> columnValueMap, String methodName) throws ServiceException {
		return Collections.emptyList();
	}

	@Override
	public List<NbfcCertificationDetails> getDataByColumnLongValue(Map<String, List<Long>> columnValueMap, String methodName) throws ServiceException {
		try {
			List<Long> idList = null;
			List<Long> entityIdList = null;
			List<Long> pageNoList = null;
			List<Long> subPageNoList = null;
			List<Long> companyTypeIdList = null;
			...
			if (methodName.equalsIgnoreCase(MethodConstants.GET_NBFC_CERTIFICATION_DETAILS_BY_ENTITY_ID.getConstantVal())) {
				...
				companyTypeIdList = columnValueMap.get(ColumnConstants.COMAPNY_TYPE_ID.getConstantVal());
	...
	@Override
	public List<NbfcCertificationDetails> getDataByObject(Map<String, Object> columnValueMap, String methodName) throws ServiceException {
		return Collections.emptyList();
	}
